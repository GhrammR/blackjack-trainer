          ...
          <div className="flex flex-col items-center gap-3 pt-2">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="rounded-md bg-slate-700 px-5 py-2.5 font-medium text-white transition hover:bg-slate-600"
              >
                Not counting
              </button>
            </div>
      ...
      {phase === 'feedback' && session && grade && (
        <div className="flex w-full flex-col gap-4">
          <div className="flex flex-col items-center gap-2 text-center">
            <p className={`text-lg font-semibold ${isVerdictCorrect ? 'text-emerald-400' : 'text-red-400'}`}>
