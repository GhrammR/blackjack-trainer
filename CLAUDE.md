...
- ▶️ **Step 8, slice 3 — Evidence-flagging (Option B). NEXT.** Mark specific suspicious rounds rather than (or alongside) an overall verdict; deferred because the ground-truth grading for "which rounds count as evidence" still needs design work.
