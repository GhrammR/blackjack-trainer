...
- ⏳ **Step 12 — "Live Count Worksheet" (operational mode, not a training drill). LATER.** Gated behind a PII/compliance review with the user's director and casino IT before any real player data can be stored. See §10 step 12 and the related roadmap-capture notes in `DECISIONS.md`.
