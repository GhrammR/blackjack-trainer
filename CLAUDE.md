...
- ▶️ **Step 8, slice 4 — Evasion mirror. NEXT.** Player-side camouflage trainer reusing the same `PlayerProfile` model, inverted: the user makes the bet/deviation choices instead of judging them.
